...
\author{Lukas Marović \and Yaroslav Hayduk}
% TODO: Update author names if needed
\email{293855@student.pwr.edu.pl \qquad 293883@student.pwr.edu.pl}
...
\begin{column}{\colwidth}
  ...
  \begin{block}{Introduction}
    ...
    \textbf{Research Question:} \textit{How do preprocessing choices, hyperparameter tuning, and model selection influence standard performance metrics and fairness outcomes across demographic groups in supervised classification?}
...
\begin{column}{\colwidth}
  ...
  \begin{block}{Models Compared}
    ...
    \begin{itemize}
      ...
      \item \textbf{k-Nearest Neighbors} --- Instance-based method
...
\begin{column}{\colwidth}
  ...
  \begin{alertblock}{Key Findings}
    ...
    \begin{itemize}
      ...
      \item \textbf{Systematic bias:} All models exhibit consistent demographic bias
    \end{itemize}
